...
router.get('/accounts/auth/facebook', auth, (req, res) => {
  ...
  const redirectUri = 'https://autogroups.herokuapp.com/platform/accounts/auth/facebook/callback';
...
router.get('/accounts/auth/instagram', auth, (req, res) => {
    const redirect_uri = 'https://autogroups.herokuapp.com/platform/accounts/auth/instagram/callback';
